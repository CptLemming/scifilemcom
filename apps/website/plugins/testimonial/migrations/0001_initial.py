...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'testimonial_testimonial', (
            ...
            ('cite', self.gf('django.db.models.fields.CharField')(max_length=128)),
        ))
    ...
    models = {
        ...
        u'testimonial.testimonial': {
            'Meta': {'object_name': 'Testimonial', '_ormbases': ['cms.CMSPlugin']},
            'cite': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
