...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'gallery_item', (
            ...
            ('plugin', self.gf('django.db.models.fields.related.ForeignKey')(related_name='items', to=orm['gallery.Gallery'])),
    ...
    models = {
        ...
        u'gallery.item': {
            ...
            'plugin': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'items'", 'to': u"orm['gallery.Gallery']"}),
